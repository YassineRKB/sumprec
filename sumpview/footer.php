    ...
    <footer id="colophon" class="site-footer">
        <!-- Standard footer content can go here -->
    </footer><!-- #colophon -->
</div><!-- #page -->

<!-- Persistent Audio Player HTML Structure -->
<div class="player-container">
    <div class="track-info">
        <img id="player-album-art" src="" alt="Album Art" style="width: 60px; height: 60px; border-radius: 4px; background-color: #333;">
        <div class="details">
            <span id="player-track-title" class="title"></span>
                ...
                <div class="fullscreen-main-controls">
                    ...
                    <div class="fs-btn-wrapper" id="fs-play-pause-wrapper">
                        <svg title="Play" class="control-btn" xmlns="http://www.w3.org/2000/svg" height="32" width="32" viewBox="0 0 24 24" id="fs-play-pause-svg">
                            <g id="fs-play-pause-icon-paths"><path d="M8 5v14l11-7z"/><path d="M0 0h24v24H0z" fill="none"/></g>
                        </svg>
                    </div>
