<?php
/**
 * Template Name: Tracks Archive (Elementor Compatible)
 * 
 * This template can be used for a custom page that displays tracks
    ...
    while ( have_posts() ) :
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            <div class="entry-content">
                ...
                // If no Elementor content, show default tracks archive
